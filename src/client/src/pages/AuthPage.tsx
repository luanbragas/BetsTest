      ...
      <div className="grid w-full max-w-6xl gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
        <div className="space-y-8">
          ...
          <div className="max-w-2xl space-y-5">
            <p className="text-xs font-black uppercase text-gold">Performance privada para banca esportiva</p>
            <h1 className="font-display text-5xl font-black leading-none text-gold-soft md:text-7xl">WililiDash</h1>
        ...
        <div className="premium-panel p-6 md:p-8">
          <div className="mb-6 flex rounded-lg border border-white/10 bg-black/20 p-1">
            <button
              className={`flex-1 rounded-lg px-4 py-3 text-sm font-black uppercase ${isSignIn ? "bg-gold text-ink" : "text-slate-400"}`}
              type="button"
